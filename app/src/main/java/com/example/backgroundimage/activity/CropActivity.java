...
import com.example.backgroundimage.dialog.CropDialog;
        ...
        mFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    CropDialog cropDialog = new CropDialog(mActivity, cropped, mActivity);
                    cropDialog.show(getFragmentManager(), "wallselectdialog");
