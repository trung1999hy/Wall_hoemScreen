...
public class AppConstant {
    ...
    public static final String KEY_5_COIN = "key_in_app_27"; // 600 coin
    public static final String KEY_6_COIN = "key_in_app_28"; // 700 coin

    public static final String KEY_7_COIN = "key_in_app_22"; // 99 coin
