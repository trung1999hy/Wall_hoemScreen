...
public class FavoriteDb {
    ...
    private ArrayList<Favorite> fetchData(Cursor c) {
        ArrayList<Favorite> favDataArray = new ArrayList<>();
        ...
        if (c != null) {
            if (c.moveToFirst()) {
                do {
                    ...
                    favDataArray.add(new Favorite(itemId, postTitle, imageUrl, postCategory));
                } while (c.moveToNext());
            }
            c.close();
        }
